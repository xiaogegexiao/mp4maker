...
query = input("")# you can change the query for the image  here
image_type="ActiOn"
query= query.split()
query='+'.join(query)
url="https://www.google.com.au/search?q="+query+"&source=lnms&tbm=isch&source=lnt&tbs=isz:ex,iszw:480,iszh:800"
print(url)
