...
/**
 * Created by xiaomei on 29/11/2016.
 */
...
//        }
        ...
        while (!outputDone) {
            ...
            if (!inputDone) {
                ...
                if (VERBOSE) Log.d(TAG, "inputBufIndex=" + inputBufIndex + ", generateIndex = " + generateIndex);
                if (inputBufIndex >= 0) {
            ...
            if (!encoderDone) {
                ...
                if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                    ...
                    if (info.size != 0) {
                        ...
                        LogUtils.D(TAG, "encoder position " + info.offset + ", limit " + (info.offset + info.size));
            ...
            if (decoderConfigured) {
                ...
                if (decoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                    ...
                    if (!toSurface) {
                        ...
                        LogUtils.D(TAG, "decoder position " + info.offset + ", limit " + (info.offset + info.size));
                        rawSize += info.size;
                        if (info.size == 0) {
